    ...
    */
    ...
    prototype: {
      ...
      updatePalette: function(){
        var ref$, nlen, vlen, i$, i, x$, node, idx, hex, this$ = this;
        ...
        hex = ldColorPicker.prototype.toHexString(this.color.vals[this.idx]);
        if (this.oldHex !== hex) {
          this.handle('change', hex);
        }
        this.oldHex = ldColorPicker.prototype.toHexString(this.color.vals[this.idx]);
      ...
      setIdx: function(idx){
        var c;
        if (this.idx !== idx) {
          this.handle('change', this.toHexString(this.color.vals[idx]));
      ...
      setHsl: function(hue, sat, lit, noRecurse){
        var hexOld, ref$, hex, litV, satV, x, y1, y2;
        noRecurse == null && (noRecurse = false);
        hexOld = this.toHexString(this.color.vals[this.idx]);
        ...
        if (this.target) {
          ...
          this.target.setAttribute("data-color", hex);
        }
        if (hexOld !== hex) {
      ...
      setPos: function(type, x, y, noRecurse){
        var ctx, ptr, ref$, ref1$, lx, ly, c, litV, satV, hue, lit, sat;
        noRecurse == null && (noRecurse = false);
        ctx = type === 2
          ? this.P2D
          : this.P1D;
